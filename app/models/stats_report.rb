class StatsReport < ApplicationRecord
  ...
  def check_for_atleast_one_data
    if(self.no_of_patients_under_observation == 0 && 
      self.no_of_patients_obs_at_home == 0 && self.no_of_patients_obs_at_hospital == 0 &&
      self.no_of_patients_admitted_today == 0 && self.no_of_patients_recovered_today  == 0 &&
      self.no_of_patients_died_today == 0)
